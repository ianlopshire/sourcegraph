...
- Support for multiple authentication providers is now enabled by default. To disable it, use the `experimentalFeatures.multipleAuthProviders` site config option. This only applies to Sourcegraph Enterprise.
